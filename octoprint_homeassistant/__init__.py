    ...
    def _generate_device_registration(self):
        ...
        self._generate_sensor(
            ...
            values={
                ...
                "stat_t": "~" + self._generate_topic("hassTopic", "printing"),
                "val_tpl": "{{unknown if not value_json.progress.printTime else value_json.progress.printTime}}",
                "dev_cla": "duration",
                "unit_of_meas": "s",
                "device": _config_device,
                "ic": "mdi:clock-start",
        ...
        self._generate_sensor(
            ...
            values={
                ...
                "stat_t": "~" + self._generate_topic("hassTopic", "printing"),
                "val_tpl": "{{unknown if not value_json.progress.printTimeLeft else value_json.progress.printTimeLeft}}",
                "dev_cla": "duration",
                "unit_of_meas": "s",
                "device": _config_device,
                "ic": "mdi:clock-end",
        ...
        self._generate_sensor(
            ...
            values={
                ...
                "val_tpl": "{{unknown if not value_json.job.estimatedPrintTime else value_json.job.estimatedPrintTime}}",
                "dev_cla": "duration",
                "unit_of_meas": "s",
                "device": _config_device,
            },
        ...
        self._generate_sensor(
            ...
            values={
                ...
                "stat_t": "~" + self._generate_topic("hassTopic", "printing"),
                "val_tpl": "{{unknown if not value_json.progress.printTimeLeft else (now() + timedelta(seconds=value_json.progress.printTimeLeft))}}",
                "dev_cla": "timestamp",
                "device": _config_device,
            },
        )
