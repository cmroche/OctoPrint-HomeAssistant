    ...
    def _generate_device_registration(self):
        ...
        self._generate_sensor(
            ...
            values={
                ...
                "stat_t": "~" + self._generate_topic("hassTopic", "printing"),
                "val_tpl": "{{'None' if not value_json.progress.printTimeLeft else value_json.job.estimatedPrintTimeLeft}}",
                "dev_cla": "duration",
                "unit_of_meas": "s",
                "device": _config_device,
                "ic": "mdi:clock-end",
        ...
        self._generate_sensor(
            ...
            values={
                ...
                "stat_t": "~" + self._generate_topic("hassTopic", "printing"),
                "val_tpl": "{{'None' if not value_json.progress.printTimeLeft else (now() + timedelta(seconds=value_json.progress.printTimeLeft|int(default=0))).timestamp()}}",
                "dev_cla": "timestamp",
                "device": _config_device,
            },
        )
