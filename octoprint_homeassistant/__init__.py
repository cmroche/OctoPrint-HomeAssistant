    ...
    def _generate_device_registration(self):
        ...
        self._generate_sensor(
            ...
            values={
                ...
                "avty_t": "~" + self._generate_topic("hassTopic", "printing"),
                "avty_tpl": "{{if value_json.job.estimatedPrintTime is not None}}",
        ...
        self._generate_sensor(
            ...
            values={
                ...
                "stat_t": "~" + self._generate_topic("hassTopic", "printing"),
                "val_tpl": "{{(now() + timedelta(seconds=value_json.progress.printTimeLeft))}}",
                "dev_cla": "timestamp",
                "device": _config_device,
            },
        )
